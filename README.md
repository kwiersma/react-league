...
| `npm run format`   | Format with Oxfmt (via Vite+)               |

## Tech Stack

- **Build**: [Vite+](https://viteplus.dev/) (Vite 8 + Rolldown)
- **Testing**: [Vitest](https://vitest.dev/) (via Vite+)
- **Linting**: [Oxlint](https://oxc.rs/docs/guide/usage/linter) (via Vite+)
- **Formatting**: [Oxfmt](https://oxc.rs/docs/guide/usage/formatter) (via Vite+)
